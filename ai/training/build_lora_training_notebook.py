...
def build_notebook() -> dict:
    ...
    cells = [
        ...
        code_cell(
            ...
            "# Belt-and-suspenders: filterwarnings() alone khong du tin cay - mot lan chay that\n"
            "# tren Kaggle (2026-09-20) van thay in day dong canh bao nay du da filterwarnings(),\n"
            "# rat co the do 1 thu vien khac (transformers/accelerate/bitsandbytes) reset lai\n"
            "# warnings filter luc khoi tao Trainer. Ghi de thang warnings.showwarning (tang thap\n"
            "# hon, it bi thu vien khac dong cham) de chan chac chan, khong phu thuoc filter list.\n"
