...
- [ ] User tải notebook đã sửa lên Kaggle (thay bản cũ), chạy lại smoke test xác nhận không còn câu hỏi kiểu dev-facing VÀ không còn lỗi hết bộ nhớ, rồi chạy toàn bộ (ước tính 10–20 phút, 1 GPU), tải kết quả về đưa lại cho tôi
